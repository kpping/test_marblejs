...
export const en = 'hello, world';
export const jp = 'ハロー・ワールド';
...
export const echoQuery$ = (req$: ReturnType<typeof assertReqQueryLang$>) =>
    req$.pipe(tap((req) => logger.info(`😀 Query => ${JSON.stringify(req.query)}`)));
